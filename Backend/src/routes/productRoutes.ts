...
import { createBulkProducts, createProduct, deleteProduct, getAllProducts, getAllProductsByCategoryId, getProductById, updateProduct } from "../controllers/productController";
